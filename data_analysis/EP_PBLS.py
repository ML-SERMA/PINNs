...
results_dir =  project_dir + '/results/'+'compare_TWIGL_2D_scaling_loss_newGPU/'
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='TWIGL_newGPU')
...
Folders = [
        'EP_Mixed_FCN_2G_TWIGL_2D_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh_random_Unscaled',
        'EP_Mixed_FCN_2G_TWIGL_2D_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh_random_Scaled',
        'EP_Mixed_FCN_2G_TWIGL_2D_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Sin_Sobol_Unscaled',
        'EP_Mixed_FCN_2G_TWIGL_2D_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Sin_Sobol_Scaled',
...
# Folders = [
#         'EP_Mixed_FCN_2G_C5G7_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh_random_Unscaled',
#         'EP_Mixed_FCN_2G_C5G7_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh_random_Scaled',
#         'EP_Mixed_FCN_2G_C5G7_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Sin_Sobol_Unscaled',
#         'EP_Mixed_FCN_2G_C5G7_SLR2e-4_09_Nit2000_HBC_nc20480_nb512_nt[120, 120]_ns2000000_nn[2, 64, 64, 64, 64, 64, 6]_Sin_Sobol_Scaled',
        
#         ]



legend=[r'UL-Tanh-Random',
        r'SL-Tanh-Random',
        r'UL-Sin-Sobol',
        r'SL-Sin-Sobol',
        ] 
