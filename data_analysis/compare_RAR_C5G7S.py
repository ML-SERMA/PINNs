...
results_dir =  project_dir + '/results/'+'Compare_RAR/'
...
Folders = [ 'Scaled_Mixed_FCN_2G_C5G7S_SLR1e-3_4000_095_HBC_nc20480_nb512_nt[120, 120]_ns500000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh',
            'RAR_Scaled_Mixed_FCN_2G_C5G7S_SLR1e-3_4000_095_HBC_nc2048_nb512_nt[120, 120]_ns500000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh',
            'RAR_iv1e5_Scaled_Mixed_FCN_2G_C5G7S_SLR1e-3_4000_095_HBC_nc2048_nb512_nt[120, 120]_ns500000_nn[2, 64, 64, 64, 64, 64, 6]_Tanh',
            
        
        ]


legend=[r'Fixed $N=20480$',r'RAR $N_0=2048$',r'RAR-2 $N_0=2048$'] 
