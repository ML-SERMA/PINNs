...
params_sigScat  = {'nameTestcase':'LWR'}
...
if isGenerateNewSolution:
    ...
    mySolution.save_solution(n='_192_172',folder_dir=savedata_dir)
visualization.viewFluxOnCell(mySolution.flux,mesh)
saveResult.saveFigures(savedata_dir,'Flux_192_172')

## 96_86: Iter= 84,        keff = 1.0069303791672344,      resKeff = 2.453647860793602e-10,        resFlux = 9.486145008075758e-06
##        Iter= 84,        keff = 1.0068124466809087,      resKeff = 2.3978712418383895e-10,       resFlux = 9.465445169354806e-06
