...
params_mesh = {'ndim':2, 'xmin':[0, 0], 'xmax':[1, 1], 'nmail':[120, 120]}
params_fem  = {'ndim':2 , 'femOrder':[0, 0]}
params_solver = {'nIterPowerInverse':1000, 'epsilonKeff': 1.e-7, 'epsilonFlux':1.e-6}
boundaryConditionType= [['ZERO_FLUX', 'ZERO_FLUX'],['ZERO_FLUX', 'ZERO_FLUX']]
params_geometry = {'ndim':2, 'xmin':[0, 0], 'xmax':[1, 1], 'ngeometry':[3, 3]}
params_sigScat  = {'nameTestcase':'Center test'}
