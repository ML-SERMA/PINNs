...
params_mesh = {'ndim':2, 'xmin':[0, 0], 'xmax':[100, 100], 'nmail':[120, 120]}
...
params_geometry = {'ndim':2, 'xmin':[0, 0], 'xmax':[100, 100], 'ngeometry':[3, 3]}
params_sigScat  = {'nameTestcase':'Constant test'}
...
visualization.viewFluxOnCell(1/mySigScat.scatEven,mesh)
nameFolder = 'EP_Constant_D1_new'
...
if isGenerateNewSolution:
    ...
    mySolution = Mono_Solver.powerInverseIteration(mesh,FEM,mySigScat,boundaryConditionType,params_solver)
    mySolution.save_solution(n=120,folder_dir=savedata_dir)
visualization.viewFluxOnCell(mySolution.flux,mesh)


'''
keff :  
        Constant D1  = 0.048215
        Center   D5  = 0.046866
        Dauge    D5  = 0.0200115
        Center   D10 = 0.046664
        Dauge    D10 = 0.015329
        
        EP_DAUGE_L100: D=5, Iter= 502,keff = 0.995126765003311, 
        EP_Center_L100: D5, Iter= 644,       keff = 0.997970361136832,
        EP_CONSTANT_L100: D=1 ,Iter= 763,       keff = 0.9980298445082054,
'''