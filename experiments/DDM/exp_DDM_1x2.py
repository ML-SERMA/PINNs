...
parser.add_argument('-t','--test', type=str, help="name of test case",default='DDM_it1000_1x2_Mixed_FCN_Constant_D1')
...
train_DDM(gridDDM=[1,2],subdo_pde=subdo_pde,subdo_data=subdo_data,params_train=params_train,n_step=1000)
