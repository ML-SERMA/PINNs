...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Mixed_DeepRitz_Center_D10_MSLR1e-3')
...
pdeData.generate_u_test(load_dir = data_dir+'Center_D10/')
