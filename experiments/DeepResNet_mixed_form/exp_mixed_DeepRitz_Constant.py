...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Mixed_DeepRitz_Constant_D1_MSLR1e-3')
...
pdeData.generate_u_test(load_dir = data_dir+'Constant_D1/')
