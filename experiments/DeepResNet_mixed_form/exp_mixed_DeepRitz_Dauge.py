...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Mixed_DeepRitz_Dauge_D10_SLR1e-3_2000_095')
...
parser.add_argument('-o','--out_N', type=int, help="an integer number",default=3)
...
params_model = {'in_N':args.in_N,'width':args.width,'depth':args.depth,'out_N':args.out_N ,'activation':args.activation,'hard_BC':False}
...
pdeData.generate_u_test(load_dir = data_dir+'Dauge_D10/RefFlux120')
...
# Visualization
visualization.viewErrorAndSolution(params_domain,[120,120],error_absolute,u_pred,u_test,save_dir)
