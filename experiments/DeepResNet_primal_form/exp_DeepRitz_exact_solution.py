...
parser.add_argument('-t','--test', type=str, help="name of test case",default='DeepRitz_Exact_2-2_D10_MSLR1e-3_HBC')
...
name_folder = args.test + '_nc' + str(args.n_collocation) + '_nb' + str(args.n_boundary) \
                + '_nt' + str(args.n_test) + '_ns' + str(args.n_step) +'_'+str(args.activation)
...
model_fcn = DeepRitzResNN(in_N=2,m=64,out_N=1,depth=3,activation=args.activation,hard_BC=True) .to(device)
