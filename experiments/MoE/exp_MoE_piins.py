...
parser.add_argument('-t','--test', type=str, help="name of test case",default='MoE_Dauge_D10_MSLR1e-3_HBC')
...
# NN configuration
MoE_layers = 2*[args.n_neuron]
MoE_activations = 2*[args.activation]
