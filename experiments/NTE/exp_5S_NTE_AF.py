...
from pyPINNs.PDE_dev.NTE_AF import NeutronTransportAngularFlux
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='5S_NTE_AF_SLR1e-3_2000_095_SBC_uniform_angular')
...
# Training Time
mypde = NeutronTransportAngularFlux(pdeDomain,model_fcn,params_pde,n_quad=n_quad,dim_angular=dim_angular,
