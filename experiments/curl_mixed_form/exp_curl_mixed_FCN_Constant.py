...
from pyPINNs.PDE.curl_mixed_diffusion_one_group import curl_mixed_diffusion_one_group
...
# Training Time
mypde = curl_mixed_diffusion_one_group(pdeDomain,model_fcn,params_pde,device)
