...
from pyPINNs.PDE_dev.curl_mixed_one_group_diffusion_source import curl_mixed_one_group_diffusion_source
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='V2_Curl_Mixed_FCN_Constant_D1_SLR1e-3_2000_095_HBC')
...
parser.add_argument('-nn','--n_neuron',nargs='+', type=int, help="an integer number",default=[2]+5*[64]+[5])
...
params_model = {'layers':args.n_neuron,'activation':args.activation,'device':device,
                'fourier_mapping_size':None,'hard_BC':'curl_mixed_L1'}
...
# Training Time
mypde = curl_mixed_one_group_diffusion_source(pdeDomain,model_fcn,params_pde,device)
