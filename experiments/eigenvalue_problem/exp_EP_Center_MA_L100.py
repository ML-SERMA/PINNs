...
parser.add_argument('-t','--test', type=str, help="name of test case",default='EP_Mixed_FCN_Center_L100_D5_MSLR1e-3_NIT4000_HBC_MA_beta0.9')
...
params_domain = {'xmin':[0, 0], 'xmax':[100, 100],'boundary_conditions': [['ZERO_FLUX', 'ZERO_FLUX'],['ZERO_FLUX', 'ZERO_FLUX']]}
...
params_solver = {'momentum':True,'beta1':0.0,'beta2':0.9,
                ...
                'anderson':False,'beta':0.8,'m':10} #beta0.8
