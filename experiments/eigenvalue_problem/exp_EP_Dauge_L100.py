...
parser.add_argument('-t','--test', type=str, help="name of test case",default='EP_Mixed_FCN_Dauge_L100_D5_MSLR1e-3_NIT2000_HBC')
...
# scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=5000, gamma=0.91)
