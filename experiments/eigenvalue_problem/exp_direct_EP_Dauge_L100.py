...
from pyPINNs.PDE_dev.direct_mixed_one_group_diffusion_eigenvalue import direct_mixed_one_group_diffusion_eigenvalue
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Direct_loss_eigen_EP_Mixed_FCN_Dauge_L100_D5_SLR1e-3')
...
params_solver = {'momentum':False,'beta1':0.0,'beta2':0.5,
                'num_inner_iters':2000, 'keff_ref':0.99513,'verbose':2,
                'anderson':False,'beta':0.8,'m':2}
