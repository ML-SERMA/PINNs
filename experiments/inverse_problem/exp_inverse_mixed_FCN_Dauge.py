...
from pyPINNs.Model.lbfgs import LBFGS
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Inverse1_Mixed_FCN_Dauge_D10_MSLR_1e-3')
...
params_train = {'n_step':args.n_step,'verbose':args.verbose,'log_every':args.log_every,'LossFile':'Loss.csv','save_dir':save_dir, 'isLossData': True,
...
# optimizer_LBFGS = LBFGS(parameters,lr=1.,line_search_fn="strong_wolfe")
