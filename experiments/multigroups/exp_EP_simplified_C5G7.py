...
from pyPINNs.PDE.mixed_eigenvalue_two_group import mixed_eigenvalue_two_group
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='EP_Mixed_FCN_2G_C5G7_SLR1e-3_Nit3000_HBC')
...
params_solver = {'momentum':False,'beta1':0.0,'beta2':0.8,
                'num_inner_iters':3000, 'keff_ref':0.927572,'verbose':2,
...
# Training Time
mypde = mixed_eigenvalue_two_group(pdeDomain,model_fcn,params_pde,params_solver,device)
