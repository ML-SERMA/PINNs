...
# print(f"==>> residu_PDE: {residu_PDE}")

# model_fcn_2G = FCN_FF(**params_model).to(device)
# params_pde_2G = {'func_D1':func_D1,'func_D2':func_D2,'func_Sigma_a1':func_Sigma_a1,'func_Sigma_a2':func_Sigma_a2,'func_Sigma_s12':func_Sigma_s12,
#             'func_S1':func_S1,'func_S2':func_S2}
# mypde_2G = mixed_diffusion_two_group(pdeDomain,model_fcn,params_pde_2G,device)

# residu_PDE_2G = mypde_2G.residual_PDE(pdeData.X_train)
