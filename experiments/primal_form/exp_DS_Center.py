...
from pyPINNs.PDE.DS_primal_diffusion_one_group import DS_primal_diffusion_one_group
...
mypde = DS_primal_diffusion_one_group(pdeDomain,model_fcn,params_pde,device)
