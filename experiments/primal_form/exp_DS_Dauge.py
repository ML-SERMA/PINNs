...
from pyPINNs.PDE.DS_primal_diffusion_one_group import D_primal_diffusion_one_group
...
mypde = D_primal_diffusion_one_group(pdeDomain,model_fcn,params_pde,device)
