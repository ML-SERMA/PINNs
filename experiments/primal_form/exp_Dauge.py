...
from pyPINNs.Model.neuron_network.FCN import FCN, FCN_FF, FCN_RegionBaseActivation
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Primal_FCN_Dauge_D10_SLR1e-3_2000_095_HBC')
...
parser.add_argument('-nn','--n_neuron',nargs='+', type=int, help="an integer number",default=[2]+7*[32]+[1])
...
params_model = {'layers':args.n_neuron,'activation':args.activation,'device':device,
                'fourier_mapping_size':None,'hard_BC':'primal_L1'}
