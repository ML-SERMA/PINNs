...
from pyPINNs.PDE.PC_primal_diffusion_one_group import PC_Center_primal_diffusion_one_group
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='PC_Primal_FCN_Center_D2_SLR1e-3_2000_095_HBC')
...
pdeData.generate_phi_test(load_dir = data_dir+'Center_D2/RefFlux120')
# pdeData.generate_p_test(load_dir = None)
# pdeData.prepare_DataLoader(batch_size_collocation=None,batch_size_boundary=None)

pdeData.generate_interface_points(n_face=512,test='Center')
...
mypde = PC_Center_primal_diffusion_one_group(pdeDomain,model_fcn,params_pde,device)
