...
from pyPINNs.PDE.PC_primal_diffusion_one_group import PC_Dauge_primal_diffusion_one_group
...
mypde = PC_Dauge_primal_diffusion_one_group(pdeDomain,model_fcn,params_pde,device)
