...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Primal_ChebyKAN_deg2_Dauge_D10_SLR1e-3_2000_095_HBC')
...
params_model = {'layer_dims':args.n_neuron,'activation':args.activation,'degree':2,'device':device,'hard_BC':'primal_L1'}
