...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Primal_FCN_IAEA_5S_MSLR1e-3')
...
parser.add_argument('-nn','--n_neuron',nargs='+', type=int, help="list of integer number",default=[2]+5*[64]+[1])
