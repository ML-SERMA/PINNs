...
from pyPINNs.Model.neuron_network.FCN import FCN, FCN_FF, FCN_FF_LLAF
...
parser.add_argument('-t','--test', type=str, help="name of test case",default='FCN_LLAF_Dauge_D10_MSLR1e-3_HBC')
...
model_fcn = FCN_FF_LLAF(**params_model).to(device)
