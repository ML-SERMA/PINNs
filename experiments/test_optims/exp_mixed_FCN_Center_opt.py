...
parser.add_argument('-t','--test', type=str, help="name of test case",default='Mixed_FCN_Center_D10_Adam_MSLR1e-3_LBFGS')
...
params_train = {'n_step': int(args.n_step/2),'verbose':args.verbose,'log_every':args.log_every,'LossFile':'Loss.csv','save_dir':save_dir,
...
optimizer_LBFGS = torch.optim.LBFGS(mypde.model.parameters(),lr=0.9,line_search_fn="strong_wolfe")
