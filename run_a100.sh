...
#SBATCH -c 8 ## 24 32 ##48                   # Nombre de coeurs
#SBATCH -p gpuq_a100                          # Partitions adaptées au job  
#SBATCH --gres=gpu:1
#SBATCH --qos=2jour                           # QOS
#SBATCH -J gpuPinns                           # Nom du job
#SBATCH --time=2-00:00:00                     # Nom du job
...
python3 -m experiments.multigroups.exp_Takeda_model1
exit 0
